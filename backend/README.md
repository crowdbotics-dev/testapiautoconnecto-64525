...
## Project Structure
    ...
    ├── testapiautoconnecto_64525  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_64525`
...
2. Clone this repo and `cd testapiautoconnecto_64525`
